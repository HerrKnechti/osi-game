...
/**
 * Class GraphicsController - Eine Klasse, die einfache grafische Zeichnungen 
...
public class GraphicsController 
{
    ...
    private static GraphicsController singleton;
    
    /**
     * Erzeugt eine GraphicsController mit Standardmaßen 600*500 und Hintergrundfarbe weiß 
     * @param titel  Titel des Fensters     
     */
    public GraphicsController(String titel)
    {
        this(titel,1200, 1000, Color.white);        
    }

    /**
     * Erzeugt ein GraphicsController mit weißem Hintergrund.
     * @param titel  Fensterueberschirft
     * @param breite  Breite des Fensters
     * @param hoehe  Hoehe des Fensters
     */
    public GraphicsController(String titel, int breite, int hoehe)
    {
        this(titel, breite, hoehe, Color.white);
    }

    /**
     * Erzeugt ein GraphicsController.
     * @param titel  Fensterueberschirft
     * @param breite  Breite des Fensters
     * @param hoehe  Hoehe des Fensters
     * @param hintergrundFarbe  Hintergrundfarbe des GraphicsControllers
     */
    private GraphicsController(String titel, int breite, int hoehe, Color hintergrundFarbe)
    {
        frame = new JFrame();
    ...
    public static GraphicsController gibFenster()
    {
        if (singleton==null){singleton=new GraphicsController("Das GraphicsController");}
        singleton.zeige();
        return singleton;
    }

    /**
     * Macht das GraphicsController sichtbar bzw. setzt es in den Vordergrund,
    ...
    /**
     * Löscht den Inhalt des GraphicsControllers.
     */
    ...
    /**
     * Löscht einen Text vom GraphicsController.
    ...
    /**
     * Zeichnet eine Strecke ins GraphicsController.
    ...
    /**
     * Setzt die Vordergrundfarbe des GraphicsControllers.
    ...
    /**
     * Gibt die aktuelle Vordergrundfarbe des GraphicsControllers zurück.
    ...
    /**
     * Setzt die Hintergrundfarbe des GraphicsControllers.
    ...
    /**
     * Gibt die aktuelle Hintergrundfarbe des GraphicsControllers zurück.
    ...
    /**
     * Ändert den aktuellen Zeichensatz des GraphicsControllers.
    ...
    /**
     * Gibt den aktuellen Zeichensatz des GraphicsControllers zurück.
    ...
    /**
     * Ändert die Abmessungen des GraphicsControllers.
    ...
    /**
     * Gibt die Abmessungen des GraphicsControllers zurück.
     * @return     die aktuellen Abmessungen des GraphicsControllers
     */
    ...
    /**
     * Beschriftet den Titel des GraphicsControllers neu.
